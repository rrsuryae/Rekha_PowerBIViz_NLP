...
The observation is that QnA could answer only specific to the data and its outcome wasnt generative in nature. 
While Narrative summarized very well statistically about the visual graph.
The Custom Visual powered by LLM - seemed to reason and answer the query based on the context data supplied to it. But it is noticed that it was still hallucinating, due to the inherent nature of the GPT. 
